    ...
    public List<BNHormiga> etlAntNest(String BN_pathFile) {
        ...
        for (String BN_raw : BN_tokens) {
            ...
            try {
                ...
                // --- CORRECCIÓN: Verificar si ya existe para evitar error UNIQUE ---
    ...
    public List<Alimento> etlAntFood(String BN_pathFile) {
        ...
        for (String BN_raw : BN_tokens) {
            ...
            try {
                ...
                // --- CORRECCIÓN: Verificar si ya existe ---
                Integer BN_idExistente = BN_alimentoDAO.getIdByNombre(BN_nombre);
                if (BN_idExistente != null) {
                    System.out.println(CMDColor.YELLOW + " -> [BaseDatos] " + BN_nombre + " ya existe. Saltando creación." + CMDColor.RESET);
                    BN_resultado.add(
